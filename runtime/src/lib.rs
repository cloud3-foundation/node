...
pub const VERSION: RuntimeVersion = RuntimeVersion {
    spec_name: create_runtime_str!("node-cloud3"),
    impl_name: create_runtime_str!("node-cloud3"),
    authoring_version: 1,
        ...
        matches!(
            ...
            RuntimeCall::Sudo(_)
                ...
                | RuntimeCall::SubtensorModule(
                    pallet_cloud3::Call::set_weights { .. }
                        | pallet_cloud3::Call::set_root_weights { .. }
                        | pallet_cloud3::Call::serve_axon { .. }
                )
...
impl OnUnbalanced<NegativeImbalance<Runtime>> for TransactionFeeHandler {
    fn on_nonzero_unbalanced(credit: NegativeImbalance<Runtime>) {
        let ti_before = pallet_cloud3::TotalIssuance::<Runtime>::get();
        pallet_cloud3::TotalIssuance::<Runtime>::put(ti_before.saturating_sub(credit.peek()));
        drop(credit);
    }
}
...
use pallet_cloud3::{CollectiveInterface, MemberManagement};
        ...
        match self {
            ...
            ProxyType::NonFungibile => !matches!(
                ...
                RuntimeCall::Balances(..)
                    | RuntimeCall::SubtensorModule(pallet_cloud3::Call::add_stake { .. })
                    | RuntimeCall::SubtensorModule(pallet_cloud3::Call::remove_stake { .. })
                    | RuntimeCall::SubtensorModule(pallet_cloud3::Call::burned_register { .. })
                    | RuntimeCall::SubtensorModule(pallet_cloud3::Call::root_register { .. })
            ),
            ...
            ProxyType::NonCritical => !matches!(
                c,
                RuntimeCall::SubtensorModule(pallet_cloud3::Call::dissolve_network { .. })
                    | RuntimeCall::SubtensorModule(pallet_cloud3::Call::root_register { .. })
                    | RuntimeCall::SubtensorModule(pallet_cloud3::Call::burned_register { .. })
            ...
            ProxyType::Registration => matches!(
                c,
                RuntimeCall::SubtensorModule(pallet_cloud3::Call::burned_register { .. })
                    | RuntimeCall::SubtensorModule(pallet_cloud3::Call::register { .. })
            ),
        }
    }
...
impl pallet_cloud3::Config for Runtime {
    type RuntimeEvent = RuntimeEvent;
    type RuntimeCall = RuntimeCall;
...
construct_runtime!(
    pub struct Runtime
    {
        ...
        SubtensorModule: pallet_cloud3 = 7,
...
pub type SignedExtra = (
    ...
    pallet_cloud3::SubtensorSignedExtension<Runtime>,
    pallet_commitments::CommitmentsSignedExtension<Runtime>,
    frame_metadata_hash_extension::CheckMetadataHash<Runtime>,
);

type Migrations =
    pallet_cloud3::migrations::migrate_init_total_issuance::initialise_total_issuance::Migration<
        Runtime,
    >;
...
impl_runtime_apis! {
    ...
    impl cloud3_custom_rpc_runtime_api::DelegateInfoRuntimeApi<Block> for Runtime {
    ...
    impl cloud3_custom_rpc_runtime_api::NeuronInfoRuntimeApi<Block> for Runtime {
    ...
    impl cloud3_custom_rpc_runtime_api::SubnetInfoRuntimeApi<Block> for Runtime {
    ...
    impl cloud3_custom_rpc_runtime_api::StakeInfoRuntimeApi<Block> for Runtime {
    ...
    impl cloud3_custom_rpc_runtime_api::SubnetRegistrationRuntimeApi<Block> for Runtime {
