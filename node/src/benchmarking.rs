...
use node_cloud3_runtime as runtime;
use node_cloud3_runtime::check_nonce;
use node_cloud3_runtime::pallet_cloud3;
...
pub fn create_benchmark_extrinsic(
    ...
    let extra: runtime::SignedExtra = (
        ...
        pallet_cloud3::SubtensorSignedExtension::<runtime::Runtime>::new(),
