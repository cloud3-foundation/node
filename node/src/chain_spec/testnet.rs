...
pub fn finney_testnet_config() -> Result<ChainSpec, String> {
    ...
    properties.insert("tokenSymbol".into(), "C3".into());
    ...
    .with_name("Cloud3")
    .with_boot_nodes(vec![
        "/dns/bootnode-test.cloud3.foudation/tcp/30333/p2p/5DSDrF67gqHfnZpGNv4sHSsz16po2xnEbCp8D7Ez33oUaxsC"
            .parse()
            .unwrap(),
    ])
    ...
    .with_genesis_config_patch(testnet_genesis(
        ...
        // Sudo account
        Ss58Codec::from_ss58check("5DSDrF67gqHfnZpGNv4sHSsz16po2xnEbCp8D7Ez33oUaxsC").unwrap(),
        // Pre-funded accounts
        vec![],
        true,
...
fn testnet_genesis(
    ...
    serde_json::json!({
        "balances": {
            ...
            "balances": vec![(
                <AccountId32 as Ss58Codec>::from_ss58check("5DSDrF67gqHfnZpGNv4sHSsz16po2xnEbCp8D7Ez33oUaxsC")
                    .unwrap(),
                1000000000000u128,
            )],
        },
