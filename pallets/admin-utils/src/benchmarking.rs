...
mod benchmarks {
    ...
    fn sudo_set_max_difficulty() {
        pallet_cloud3::Pallet::<T>::init_new_network(1u16 /*netuid*/, 1u16 /*tempo*/);
    ...
    #[benchmark]
    fn sudo_set_kappa() {
        pallet_cloud3::Pallet::<T>::init_new_network(
            1u16, /*netuid*/
            1u16, /*sudo_tempo*/
        );
    ...
    /*
        ...
        pallet_cloud3::Pallet::<T>::init_new_network(netuid, tempo);
