...
pub mod pallet {
    ...
    #[pallet::config]
    pub trait Config: frame_system::Config + pallet_cloud3::pallet::Config {
    ...
    impl<T: Config> Pallet<T> {
        ...
        pub fn sudo_set_default_take(origin: OriginFor<T>, default_take: u16) -> DispatchResult {
            ensure_root(origin)?;
            pallet_cloud3::Pallet::<T>::set_max_delegate_take(default_take);
        ...
        pub fn sudo_set_tx_rate_limit(origin: OriginFor<T>, tx_rate_limit: u64) -> DispatchResult {
            ensure_root(origin)?;
            pallet_cloud3::Pallet::<T>::set_tx_rate_limit(tx_rate_limit);
        ...
        pub fn sudo_set_serving_rate_limit(
            ...
            pallet_cloud3::Pallet::<T>::ensure_subnet_owner_or_root(origin, netuid)?;

            pallet_cloud3::Pallet::<T>::set_serving_rate_limit(netuid, serving_rate_limit);
            log::debug!(
        ...
        pub fn sudo_set_min_difficulty(
            ...
            pallet_cloud3::Pallet::<T>::ensure_subnet_owner_or_root(origin, netuid)?;
                ...
                pallet_cloud3::Pallet::<T>::if_subnet_exist(netuid),
                Error::<T>::SubnetDoesNotExist
            );
            pallet_cloud3::Pallet::<T>::set_min_difficulty(netuid, min_difficulty);
            log::debug!(
        ...
        pub fn sudo_set_max_difficulty(
            ...
            pallet_cloud3::Pallet::<T>::set_max_difficulty(netuid, max_difficulty);
            log::debug!(
        ...
        pub fn sudo_set_weights_version_key(
            ...
            pallet_cloud3::Pallet::<T>::set_weights_version_key(netuid, weights_version_key);
            log::debug!(
        ...
        pub fn sudo_set_weights_set_rate_limit(
            ...
            pallet_cloud3::Pallet::<T>::set_weights_set_rate_limit(
                netuid,
        ...
        pub fn sudo_set_adjustment_interval(
            ...
            pallet_cloud3::Pallet::<T>::set_adjustment_interval(netuid, adjustment_interval);
            log::debug!(
        ...
        pub fn sudo_set_adjustment_alpha(
            ...
            pallet_cloud3::Pallet::<T>::set_adjustment_alpha(netuid, adjustment_alpha);
            log::debug!(
        ...
        pub fn sudo_set_max_weight_limit(
            ...
            pallet_cloud3::Pallet::<T>::set_max_weight_limit(netuid, max_weight_limit);
            log::debug!(
        ...
        pub fn sudo_set_immunity_period(
            ...
            pallet_cloud3::Pallet::<T>::set_immunity_period(netuid, immunity_period);
            log::debug!(
        ...
        pub fn sudo_set_min_allowed_weights(
            ...
            pallet_cloud3::Pallet::<T>::set_min_allowed_weights(netuid, min_allowed_weights);
            log::debug!(
        ...
        pub fn sudo_set_max_allowed_uids(
            ...
            ensure_root(origin)?;
                ...
                pallet_cloud3::Pallet::<T>::get_subnetwork_n(netuid) < max_allowed_uids,
                Error::<T>::MaxAllowedUIdsLessThanCurrentUIds
            );
            pallet_cloud3::Pallet::<T>::set_max_allowed_uids(netuid, max_allowed_uids);
            log::debug!(
        ...
        pub fn sudo_set_kappa(origin: OriginFor<T>, netuid: u16, kappa: u16) -> DispatchResult {
            ...
            pallet_cloud3::Pallet::<T>::set_kappa(netuid, kappa);
        ...
        pub fn sudo_set_rho(origin: OriginFor<T>, netuid: u16, rho: u16) -> DispatchResult {
            ...
            pallet_cloud3::Pallet::<T>::set_rho(netuid, rho);
        ...
        pub fn sudo_set_activity_cutoff(
            ...
            pallet_cloud3::Pallet::<T>::set_activity_cutoff(netuid, activity_cutoff);
            log::debug!(
        ...
        pub fn sudo_set_network_registration_allowed(
            ...
            pallet_cloud3::Pallet::<T>::set_network_registration_allowed(
                netuid,
        ...
        pub fn sudo_set_network_pow_registration_allowed(
            ...
            pallet_cloud3::Pallet::<T>::set_network_pow_registration_allowed(
                netuid,
                registration_allowed,
            );
            log::debug!(
        ...
        pub fn sudo_set_target_registrations_per_interval(
            ...
            pallet_cloud3::Pallet::<T>::set_target_registrations_per_interval(
                netuid,
        ...
        pub fn sudo_set_min_burn(
            ...
            pallet_cloud3::Pallet::<T>::set_min_burn(netuid, min_burn);
            log::debug!(
        ...
        pub fn sudo_set_max_burn(
            ...
            pallet_cloud3::Pallet::<T>::set_max_burn(netuid, max_burn);
            log::debug!(
        ...
        pub fn sudo_set_difficulty(
            ...
            pallet_cloud3::Pallet::<T>::set_difficulty(netuid, difficulty);
            log::debug!(
        ...
        pub fn sudo_set_max_allowed_validators(
            ...
            ensure_root(origin)?;
                ...
                max_allowed_validators
                    <= pallet_cloud3::Pallet::<T>::get_max_allowed_uids(netuid),
                Error::<T>::MaxValidatorsLargerThanMaxUIds
            );

            pallet_cloud3::Pallet::<T>::set_max_allowed_validators(
                netuid,
                max_allowed_validators,
            );
            log::debug!(
        ...
        pub fn sudo_set_bonds_moving_average(
            ...
            pallet_cloud3::Pallet::<T>::set_bonds_moving_average(netuid, bonds_moving_average);
            log::debug!(
        ...
        pub fn sudo_set_max_registrations_per_block(
            ...
            pallet_cloud3::Pallet::<T>::set_max_registrations_per_block(
                netuid,
        ...
        pub fn sudo_set_subnet_owner_cut(
            ...
            ensure_root(origin)?;
            pallet_cloud3::Pallet::<T>::set_subnet_owner_cut(subnet_owner_cut);
            log::debug!(
        ...
        pub fn sudo_set_network_rate_limit(
            ...
            ensure_root(origin)?;
            pallet_cloud3::Pallet::<T>::set_network_rate_limit(rate_limit);
        ...
        pub fn sudo_set_tempo(origin: OriginFor<T>, netuid: u16, tempo: u16) -> DispatchResult {
            ...
            pallet_cloud3::Pallet::<T>::set_tempo(netuid, tempo);
        ...
        pub fn sudo_set_total_issuance(
            ...
            pallet_cloud3::Pallet::<T>::set_total_issuance(total_issuance);
        ...
        pub fn sudo_set_network_immunity_period(
            ...
            pallet_cloud3::Pallet::<T>::set_network_immunity_period(immunity_period);
        ...
        pub fn sudo_set_network_min_lock_cost(
            ...
            pallet_cloud3::Pallet::<T>::set_network_min_lock(lock_cost);
        ...
        pub fn sudo_set_subnet_limit(origin: OriginFor<T>, max_subnets: u16) -> DispatchResult {
            ensure_root(origin)?;
            pallet_cloud3::Pallet::<T>::set_max_subnets(max_subnets);
        ...
        pub fn sudo_set_lock_reduction_interval(
            ...
            pallet_cloud3::Pallet::<T>::set_lock_reduction_interval(interval);
        ...
        pub fn sudo_set_rao_recycled(
            ...
            pallet_cloud3::Pallet::<T>::set_rao_recycled(netuid, rao_recycled);
            Ok(())
        }
        ...
        pub fn sudo_set_weights_min_stake(origin: OriginFor<T>, min_stake: u64) -> DispatchResult {
            ensure_root(origin)?;
            pallet_cloud3::Pallet::<T>::set_weights_min_stake(min_stake);
            Ok(())
        }
        ...
        pub fn sudo_set_nominator_min_required_stake(
            ...
            ensure_root(origin)?;
            let prev_min_stake = pallet_cloud3::Pallet::<T>::get_nominator_min_required_stake();
            log::trace!("Setting minimum stake to: {}", min_stake);
            pallet_cloud3::Pallet::<T>::set_nominator_min_required_stake(min_stake);
            if min_stake > prev_min_stake {
                log::trace!("Clearing small nominations");
                pallet_cloud3::Pallet::<T>::clear_small_nominations();
        ...
        pub fn sudo_set_tx_delegate_take_rate_limit(
            ...
            ensure_root(origin)?;
            pallet_cloud3::Pallet::<T>::set_tx_delegate_take_rate_limit(tx_rate_limit);
            log::debug!(
        ...
        pub fn sudo_set_min_delegate_take(origin: OriginFor<T>, take: u16) -> DispatchResult {
            ensure_root(origin)?;
            pallet_cloud3::Pallet::<T>::set_min_delegate_take(take);
        ...
        pub fn sudo_set_target_stakes_per_interval(
            ...
            ensure_root(origin)?;
            pallet_cloud3::Pallet::<T>::set_target_stakes_per_interval(
        ...
        pub fn sudo_set_commit_reveal_weights_interval(
            ...
            pallet_cloud3::Pallet::<T>::set_commit_reveal_weights_interval(netuid, interval);
            log::debug!(
        ...
        pub fn sudo_set_commit_reveal_weights_enabled(
            ...
            pallet_cloud3::Pallet::<T>::set_commit_reveal_weights_enabled(netuid, enabled);
        ...
        pub fn sudo_set_liquid_alpha_enabled(
            ...
            pallet_cloud3::Pallet::<T>::ensure_subnet_owner_or_root(origin, netuid)?;
            pallet_cloud3::Pallet::<T>::set_liquid_alpha_enabled(netuid, enabled);
            log::debug!(
        ...
        pub fn sudo_set_alpha_values(
            ...
            pallet_cloud3::Pallet::<T>::ensure_subnet_owner_or_root(origin.clone(), netuid)?;
            pallet_cloud3::Pallet::<T>::do_set_alpha_values(
        ...
        pub fn sudo_set_hotkey_emission_tempo(
            ...
            ensure_root(origin)?;
            pallet_cloud3::Pallet::<T>::set_hotkey_emission_tempo(emission_tempo);
            log::debug!(
        ...
        pub fn sudo_set_network_max_stake(
            ...
            pallet_cloud3::Pallet::<T>::set_network_max_stake(netuid, max_stake);
        ...
        pub fn sudo_set_coldkey_swap_schedule_duration(
            ...
            pallet_cloud3::Pallet::<T>::set_coldkey_swap_schedule_duration(duration);
        ...
        pub fn sudo_set_dissolve_network_schedule_duration(
            ...
            pallet_cloud3::Pallet::<T>::set_dissolve_network_schedule_duration(duration);
